...
print('Введите номер горизонтали первой фигуры (l): ')
x1 = int(input())
print('Введите букву вертикали первой фигуры (k): ')
    ...
    if name == 'ферзь' or name == 'Ферзь':
        if y1 == y2 or x1 == x2 or module_x == module_y:
            ...
            print('На позицию второй фигуры можно попасть за 2 хода:\n',
                  'Первый ход на:', letters[y1]+str(new_x1))
            new_y1 = y2
            print(' Второй ход на:', letters[new_y1]+str(new_x1))
